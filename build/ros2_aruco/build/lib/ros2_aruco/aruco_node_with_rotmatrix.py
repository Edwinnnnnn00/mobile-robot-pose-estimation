...
class ArucoNode(rclpy.node.Node):
    def __init__(self):
        ...
        self.declare_parameter(
            name="image_topic",
            value="/camera/color/image_raw",        #hardware
            # value="/realsense/color/image_raw",   #simulation
            descriptor=ParameterDescriptor(
                type=ParameterType.PARAMETER_STRING,
        ...
        self.declare_parameter(
            ...
            value="/camera/color/camera_info",          #hardware
            # value="/realsense/color/camera_info",     #simulation
            descriptor=ParameterDescriptor(
                type=ParameterType.PARAMETER_STRING,
